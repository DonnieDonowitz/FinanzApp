...
protocol AppTinting {
    ...
    static var glassHighlight: Color { get }
    static var glassHighlightStrong: Color { get }
    ...
    static var fabricIconBg: Color { get }
    static var fabricBorder: Color { get }
    static var balanceGradient: [Color] { get }
    static var balanceHighlight: [Color] { get }
}

// MARK: - Dark (matches brand kit dark HTML)

enum DarkTints: AppTinting {
    static let bg = [Color(hex: "#0A0C14"), Color(hex: "#0D0F1A"), Color(hex: "#08090F")]
    ...
    static let glassHighlightStrong = Color.white.opacity(0.18)
    static let text = Color(hex: "#F2F4F8")
    static let textSecondary = Color.white.opacity(0.68)
    static let textTertiary = Color.white.opacity(0.42)
    static let primary = Color(hex: "#7B6FE8")
    static let accent = Color(hex: "#5A82FF")
    static let income = Color(hex: "#2FE8B0")
    static let incomeLight = Color(hex: "#B9FFE3")
    static let expense = Color(hex: "#FF7A7A")
    static let expenseLight = Color(hex: "#FFD3D3")
    static let gold = Color(hex: "#FFCF70")
    static let lavender = Color(hex: "#B29DFF")
    static let divider = Color.white.opacity(0.08)
    static let overlay = Color.black.opacity(0.50)
    static let inputBg = Color.black.opacity(0.25)
    static let tabBar = Color.white.opacity(0.07)
    static let tabBarBorder = Color.white.opacity(0.14)
    static let tabActive = Color(hex: "#F2F4F8")
    static let tabInactive = Color(hex: "#F2F4F8").opacity(0.5)
    static let shadow = Color.black.opacity(0.55)
    static let fabricIconBg = Color.white.opacity(0.18)
    static let fabricBorder = Color.white.opacity(0.25)
    static let balanceGradient = [Color.white.opacity(0.06), Color.white.opacity(0.0)]
    static let balanceHighlight = [Color.white.opacity(0.12), Color.white.opacity(0)]
}

// MARK: - Light (matches brand kit light HTML)

enum LightTints: AppTinting {
    static let bg = [Color(hex: "#F4F1FB"), Color(hex: "#EDF1FA"), Color(hex: "#E9F6F6")]
    ...
    static let glassBorderStrong = Color.black.opacity(0.09)
    static let glassHighlight = Color.white.opacity(0.6)
    static let glassHighlightStrong = Color.white.opacity(0.8)
    static let text = Color(hex: "#0B1120")
    static let textSecondary = Color(hex: "#0B1120").opacity(0.64)
    static let textTertiary = Color(hex: "#0B1120").opacity(0.45)
    static let primary = Color(hex: "#5E52D6")
    static let accent = Color(hex: "#3D74DD")
    static let income = Color(hex: "#0AA57C")
    static let incomeLight = Color(hex: "#0AA57C")
    static let expense = Color(hex: "#E14545")
    static let expenseLight = Color(hex: "#E14545")
    static let gold = Color(hex: "#B8860B")
    static let lavender = Color(hex: "#7C5FE0")
    static let divider = Color.black.opacity(0.08)
    static let overlay = Color.black.opacity(0.30)
    static let inputBg = Color.black.opacity(0.05)
    static let tabBar = Color.white.opacity(0.65)
    static let tabBarBorder = Color.black.opacity(0.08)
    static let tabActive = Color(hex: "#0B1120")
    static let tabInactive = Color(hex: "#0B1120").opacity(0.42)
    static let shadow = Color.black.opacity(0.14)
    static let fabricIconBg = Color.black.opacity(0.05)
    static let fabricBorder = Color.black.opacity(0.08)
    static let balanceGradient = [Color.white.opacity(0.5), Color.white.opacity(0.0)]
    static let balanceHighlight = [Color.white.opacity(0.7), Color.white.opacity(0)]
}
...
struct AppColors {
    ...
    static var glassHighlight: Color { T.glassHighlight }
    static var glassHighlightStrong: Color { T.glassHighlightStrong }
    ...
    static var gold: Color { T.gold }
    static var lavender: Color { T.lavender }
    static var divider: Color { T.divider }
    static var overlay: Color { T.overlay }
    static var inputBg: Color { T.inputBg }
    ...
    static var fabricIconBg: Color { T.fabricIconBg }
    static var fabricBorder: Color { T.fabricBorder }
    static var balanceGradient: [Color] { T.balanceGradient }
    static var balanceHighlight: [Color] { T.balanceHighlight }
}
...
// MARK: - Background Gradient (brand kit style)
...
struct BackgroundGradient: View {
    ...
    var body: some View {
        if !vm.isDarkMode {
            ZStack {
                LinearGradient(
                    colors: [Color(hex: "#B9B3ED"), Color(hex: "#A8C4EE"), Color(hex: "#9BDCE9")],
                    startPoint: UnitPoint(x: 0.5, y: 0),
                    endPoint: UnitPoint(x: 0.5, y: 1)
                )
                RadialGradient(gradient: Gradient(stops: [.init(color: Color(hex: "#FF9F6B").opacity(0.45), location: 0), .init(color: .clear, location: 0.40)]), center: UnitPoint(x: 0.22, y: 0.18), startRadius: 0, endRadius: 280)
                RadialGradient(gradient: Gradient(stops: [.init(color: Color(hex: "#A78BFA").opacity(0.40), location: 0), .init(color: .clear, location: 0.42)]), center: UnitPoint(x: 0.82, y: 0.12), startRadius: 0, endRadius: 280)
                RadialGradient(gradient: Gradient(stops: [.init(color: Color(hex: "#1FD8A4").opacity(0.40), location: 0), .init(color: .clear, location: 0.42)]), center: UnitPoint(x: 0.15, y: 0.78), startRadius: 0, endRadius: 280)
                RadialGradient(gradient: Gradient(stops: [.init(color: Color(hex: "#4C6FFF").opacity(0.40), location: 0), .init(color: .clear, location: 0.46)]), center: UnitPoint(x: 0.88, y: 0.85), startRadius: 0, endRadius: 280)
                LinearGradient(colors: [Color.white.opacity(0.35), Color.white.opacity(0)], startPoint: .top, endPoint: .bottom)
            }
            .ignoresSafeArea()
        } else {
            ZStack {
                LinearGradient(colors: [Color(hex: "#0A0C14"), Color(hex: "#0D0F1A"), Color(hex: "#08090F")],
                               startPoint: UnitPoint(x: 0.5, y: 0), endPoint: UnitPoint(x: 0.5, y: 1))
                RadialGradient(gradient: Gradient(stops: [.init(color: Color(hex: "#FF7A7A").opacity(0.35), location: 0), .init(color: .clear, location: 0.38)]), center: UnitPoint(x: 0.22, y: 0.15), startRadius: 0, endRadius: 280)
                RadialGradient(gradient: Gradient(stops: [.init(color: Color(hex: "#B29DFF").opacity(0.32), location: 0), .init(color: .clear, location: 0.40)]), center: UnitPoint(x: 0.85, y: 0.10), startRadius: 0, endRadius: 280)
                RadialGradient(gradient: Gradient(stops: [.init(color: Color(hex: "#2FE8B0").opacity(0.30), location: 0), .init(color: .clear, location: 0.42)]), center: UnitPoint(x: 0.12, y: 0.80), startRadius: 0, endRadius: 280)
                RadialGradient(gradient: Gradient(stops: [.init(color: Color(hex: "#5A82FF").opacity(0.32), location: 0), .init(color: .clear, location: 0.46)]), center: UnitPoint(x: 0.90, y: 0.88), startRadius: 0, endRadius: 280)
            }
            .ignoresSafeArea()
        }
    }
