...
enum L {
    ...
    static var autoBackupHint: String { t(it: "Un backup viene salvato automaticamente una volta al giorno nella cartella FinanzApp dell'app File; vengono conservati solo gli ultimi due.", en: "A backup is saved automatically once a day in the FinanzApp folder in the Files app; only the last two are kept.", de: "Einmal täglich wird automatisch eine Sicherung im Ordner FinanzApp der Dateien-App gespeichert; es werden nur die letzten zwei aufbewahrt.", fr: "Une sauvegarde est enregistrée automatiquement une fois par jour dans le dossier FinanzApp de l'app Fichiers ; seules les deux dernières sont conservées.", es: "Se guarda automáticamente una copia de seguridad una vez al día en la carpeta FinanzApp de la app Archivos; solo se conservan las dos últimas.") }
    ...
    static var expenseAlertsHint: String { t(it: "Ricevi una notifica quando le spese del mese raggiungono la percentuale del budget che scegli tu, senza soglie preimpostate.", en: "Get notified when this month's expenses reach the percentage of your budget you choose — no built-in presets.", de: "Erhalte eine Benachrichtigung, wenn die Ausgaben dieses Monats den von dir gewählten Prozentsatz deines Budgets erreichen — keine voreingestellten Schwellenwerte.", fr: "Recevez une notification lorsque les dépenses du mois atteignent le pourcentage de votre budget que vous choisissez — aucun seuil prédéfini.", es: "Recibe una notificación cuando los gastos de este mes alcancen el porcentaje de tu presupuesto que elijas — sin umbrales predefinidos.") }
    ...
    static var expenseAlertThresholdLabel: String { t(it: "Avvisami al", en: "Notify me at", de: "Benachrichtigen bei", fr: "M'avertir à", es: "Avisarme al") }
    static var thresholdPlaceholder: String { t(it: "%", en: "%", de: "%", fr: "%", es: "%") }
    static func expenseAlertBody(percent: Int) -> String {
        t(it: "Stai spendendo abbastanza per questo mese! Ricorda di mettere da parte! Hai speso \(percent)% del tuo budget mensile!",
          en: "You're spending quite a lot this month! Remember to set some money aside! You've spent \(percent)% of your monthly budget!",
          de: "Du gibst diesen Monat ganz schön viel aus! Denk daran, etwas zurückzulegen! Du hast \(percent)% deines monatlichen Budgets ausgegeben!",
          fr: "Vous dépensez pas mal ce mois-ci ! Pensez à mettre de l'argent de côté ! Vous avez dépensé \(percent)% de votre budget mensuel !",
          es: "¡Estás gastando bastante este mes! ¡Recuerda apartar algo de dinero! ¡Has gastado el \(percent)% de tu presupuesto mensual!")
    }
